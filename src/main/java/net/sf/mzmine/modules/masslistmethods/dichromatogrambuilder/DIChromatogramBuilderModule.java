...
public class DIChromatogramBuilderModule implements MZmineProcessingModule {

    private static final String MODULE_NAME = "DI-Chromatogram builder";
    ...
    public ExitCode runModule(@Nonnull MZmineProject project,
        ...
        for (int i = 0; i < dataFiles.length; i++) {
            Task newTask = new DIChromatogramBuilderTask(project, dataFiles[i],
    ...
    public @Nonnull Class<? extends ParameterSet> getParameterSetClass() {
        return DIChromatogramBuilderParameters.class;
    }
