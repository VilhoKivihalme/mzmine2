...
public class DIChromatogramBuilderTask extends AbstractTask {
    ...
    public DIChromatogramBuilderTask(MZmineProject project,
        ...
        this.scanSelection = parameters
                .getParameter(DIChromatogramBuilderParameters.scanSelection)
                .getValue();
        this.massListName = parameters
                .getParameter(DIChromatogramBuilderParameters.massList)
                .getValue();

        this.mzTolerance = parameters
                .getParameter(DIChromatogramBuilderParameters.mzTolerance)
                .getValue();
        this.minimumTimeSpan = parameters
                .getParameter(DIChromatogramBuilderParameters.minimumTimeSpan)
                .getValue();
        this.minimumHeight = parameters
                .getParameter(DIChromatogramBuilderParameters.minimumHeight)
                .getValue();
